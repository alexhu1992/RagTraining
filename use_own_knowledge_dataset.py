...
def main(
    ...
    logger.info(f"dataseret: {dataset}")
    ...
    question = rag_example_args.question or "Customer is not able to route to cloud robots with 404 errors"
    input_ids = tokenizer.question_encoder(question, return_tensors="pt")["input_ids"]
    generated = model.generate(input_ids)
    generated_string = tokenizer.batch_decode(generated, skip_special_tokens=True)[0]
    logger.info("Q: " + question)
    logger.info("A: " + generated_string)
    logger.info(tokenizer.batch_decode(generated, skip_special_tokens=True))
